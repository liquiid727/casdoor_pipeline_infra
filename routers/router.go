...
func InitAPI() {
	...
	web.Router("/api/get-channel-relations", &controllers.ApiController{}, "GET:GetChannelRelations")
	web.Router("/api/get-channel-relation", &controllers.ApiController{}, "GET:GetChannelRelation")
	web.Router("/api/add-channel-relation", &controllers.ApiController{}, "POST:AddChannelRelation")
	web.Router("/api/update-channel-relation", &controllers.ApiController{}, "POST:UpdateChannelRelation")
	web.Router("/api/delete-channel-relation", &controllers.ApiController{}, "POST:DeleteChannelRelation")
	...
	web.Router("/api/get-user-channels", &controllers.ApiController{}, "GET:GetUserChannels")
	web.Router("/api/get-user-channel", &controllers.ApiController{}, "GET:GetUserChannel")
	web.Router("/api/bind-user-channel", &controllers.ApiController{}, "POST:BindUserChannel")
	web.Router("/api/update-user-channel", &controllers.ApiController{}, "POST:UpdateUserChannel")
	web.Router("/api/unbind-user-channel", &controllers.ApiController{}, "POST:UnbindUserChannel")
