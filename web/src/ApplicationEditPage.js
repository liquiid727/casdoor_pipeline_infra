...
<div class="left-model">
  <span class="side-logo"> <img src="${Setting.StaticBaseUrl}/img/logo.png" alt="Pipeline Auth" style="width: 120px">
    <span>SSO</span>
  </span>
  <div class="img">
    <img src="${Setting.StaticBaseUrl}/img/casbin.svg" alt="Pipeline Auth"/>
  </div>
</div>
`;
